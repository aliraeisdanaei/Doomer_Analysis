...
In particular, Fardghassemi \textit{et al.} interviewed young adults in London's deprived boroughs to answer such a question.  
This is approach is great, in so far as it asks the question to the right people, yet it is limited in its vastness. 
The cost to find and conduct interviews is high; therefore, only a small number of participants can be used.
Fardghasssemi used only 48 participants. 

With any internet subculture, 
